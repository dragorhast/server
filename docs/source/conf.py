...
project = 'tap2go server'
copyright = '2018, Dragorhast'
author = 'Dragorhast'
...
htmlhelp_basename = 'tap2goserver'
...
latex_documents = [
    (master_doc, 'tap2goserver.tex', 'tap2go server Documentation',
     'Dragorhast', 'manual'),
]
...
man_pages = [
    (master_doc, 'tap2goserver', 'tap2go server Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'tap2goserver', 'tap2go server Documentation',
     author, 'tap2goserver', 'One line description of project.',
     'Miscellaneous'),
]
