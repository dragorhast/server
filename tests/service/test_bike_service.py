...
bad_key_type = strategies.one_of(strategies.integers(), strategies.floats(), strategies.none(), strategies.booleans())


@pytest.mark.asyncio
@given(first_key=bad_key_type, second_key=bad_key_type)
